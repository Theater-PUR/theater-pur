          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  Was als kleine Gruppe theaterbegeisterter Freunde begann, ist
                  heute eine lebendige Gemeinschaft von über 25 aktiven
                  Mitgliedern. Theaterpur Weyhe wurde gegründet aus der
                  Überzeugung, dass Theater Menschen zusammenbringt und
                  Geschichten erzählt, die berühren.
                </p>
                <p>
                  In über 30 Produktionen haben wir unser Publikum zum Lachen,
                  Weinen und Nachdenken gebracht. Von klassischen Komödien über
                  moderne Dramen bis hin zu eigenen Adaptionen – wir scheuen
                  keine Herausforderung.
                </p>
                <p>
                  Unsere Aufführungen finden an verschiedenen Spielstätten in
                  und um Weyhe statt. Jede Produktion ist ein
                  Gemeinschaftsprojekt, bei dem jeder sein Talent einbringt – ob
                  auf der Bühne, beim Bühnenbau, bei Kostümen oder in der
                  Organisation.
                </p>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="bg-card p-8 rounded-lg border border-border/50">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button
                  type="submit"
                  className="w-full font-semibold shadow-gold"
                >
                  Nachricht Senden
                </Button>
              </form>
