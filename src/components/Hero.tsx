...
export function Hero({
  ...
  return (
    <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto space-y-6 animate-fade-up">
          ...
          {(ctaText || secondaryCtaText) && (
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              {ctaText && ctaLink && (
                <Button asChild size="lg" className="font-semibold shadow-gold animate-glow-pulse group">
                  <Link to={ctaLink}>
                    {ctaText}
              ...
              {secondaryCtaText && secondaryCtaLink && (
                <Button asChild variant="outline" size="lg" className="font-semibold border-primary/30 text-foreground hover:bg-primary/10">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-velvet/10 rounded-full blur-3xl animate-spotlight" style={{ animationDelay: "2s" }} />
    </section>
  );
}
